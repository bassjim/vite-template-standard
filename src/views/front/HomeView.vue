<template>
  <div class="home">
    <div class="position-relative">
      <div class="position-absolute" style="top:0; bottom:0; left:0; right:0; background-image: url(https://images.pexels.com/photos/4822293/pexels-photo-4822293.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1);
      background-position: center center; opacity: 0.2;"></div>
      <div class="container d-flex flex-column" style="min-height: 100vh;">
        <div class="row justify-content-center my-auto">
          <div class="col-md-4 text-center">
            <h1>台灣二手路亞交流平台.</h1>
            <p class="text-muted mb-0">每一個路亞釣手都有大魚夢，快來加入這個大家族吧!</p>
